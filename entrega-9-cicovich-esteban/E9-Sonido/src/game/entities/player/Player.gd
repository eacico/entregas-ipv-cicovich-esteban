...
onready var hit_sfx:AudioStream = load("res://assets/sound/sfx/player/11_human_damage_1.wav")
...
func play_sound(sfx:AudioStream):
	audio_stream_player.connect("finished", self, "_on_sfx_stream_finished")
